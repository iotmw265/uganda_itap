        ...
        <ul class="nav metismenu" id="side-menu" style='background:#ffffff;'>
            ...
            <li class="nav-header" style='background: #ffffff !important'>
                <div class="dropdown profile-element">
                    <span>
                        <img alt="image" class="rounded-circle img-lg" src="{!! asset('img/nbs-bank.png') !!}"
                            style=" width:201px;height:70px" />
                    </span>
                    
                <br/>
                <br/>
                    <div style='background-color: #e7313f !important;padding: 7px; border-top-left-radius: 10px; border-bottom-left-radius: 10px;'>
            ...
            <li  style='background:#ffffff;'>
                <a ><i class="fa fa-laptop" style='color: #244183'></i> <span class="nav-label" style='color: #244183'><strong> Power State</strong></span> <!--span
                        class="fa arrow"></span--></a>

                <ul class="nav nav-second-level collapse in" aria-expanded="true" >
                    <!-- <li class="active"><a href="{{ url('/mlw-dash') }}">Home</a></li> -->

                    <li class="{{ Request::is('power_states') ? 'active' : '' }}" ><a href="{{ route('power_states.dashboard') }}">
                            <span class="menu-icon">
                                <i class="fa fa-window-maximize"  style='color: #244183' id="icon3"></i>
                            </span>
                            <span class="menu-title" style='color: #244183'>Dashboard</span>
                    ...
                    <li class="{{ Request::is('power_states/reports') ? 'active' : '' }}"><a href="{{ route('power_states.report') }}">
                            <span class="menu-icon">
                                <i class="fa fa-bar-chart" style='color: #244183' id="icon3"></i>
                            </span>
                            <span class="menu-title" style='color: #244183'>Reports</span>
