...
@section('content')
    <div class="container">
        <div class="card m-3 p-4">
            ...
            <form method="POST" action="{{ route('users.update.password', $users->id) }}" class="container" onsubmit="return validatePassword()">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3" style='margin-top:15px;'>
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="form-label" style="color:darkgrey">New Password</label>
                            <input type="password" id="password" name="password" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label for="password_confirmation" class="form-label" style="color:darkgrey ">Confirm New Password</label>
