...
class SendTemperatureAlerts extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'alerts:temperature';
     ...
     * @var string
     */
    protected $description = 'Broadcast temperature alerts';
    ...
    public function handle()
    {
       ...
       $temp_records = DB::table('alerts')->where('status','pending')->where('parameter','temperature')->get();
       ...
       /*foreach ( $temp_records as $row)
       {
           ...
           if($ieee == "AAACD0FEFF2C6A3C" || $ieee == "99ACD0FEFF2C6A3C") {
               ...
               $message = "Room Temperature in Blantyre data center has gone above threshold. It is currently at ".$value."°C.\n\n[NOTE: IMS autogenerated message]";
               ...
               DB::table('alerts')->where('ieee',$ieee)->update(['status' => 'sent',]);
                   ...
                   $title = "Centenary Bank Server Room";
                   $message = "Room Temperature in Lilongwe data center has gone above threshold. It is currently at ".$value."°C.\n\n[NOTE: IMS autogenerated message]";
